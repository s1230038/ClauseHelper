...
describe('Parenthesis Correspondence', () => {
  ...
  it('should replace tricky parenthesis blocks', () => {
    const inputText = `（特別取締役による取締役会の決議）
    ...
    const expected0 = `（…）
    第373条　第369条第1項の規定にかかわらず、取締役会設置会社（…）が次に掲げる要件のいずれにも該当する場合（…）には、取締役会は、第362条第4項第一号及び第二号又は第399条の13第4項第一号及び第二号に掲げる事項についての取締役会の決議については、あらかじめ選定した三人以上の取締役（…）のうち、議決に加わることができるものの過半数（…）が出席し、その過半数（…）をもって行うことができる旨を定めることができる。
    一　取締役の数が六人以上であること。
    二　取締役のうち一人以上が社外取締役であること。
    2　前項の規定による特別取締役による議決の定めがある場合には、特別取締役以外の取締役は、第362条第4項第一号及び第二号又は第399条の13第4項第一号及び第二号に掲げる事項の決定をする取締役会に出席することを要しない。この場合における第366条第1項本文及び第368条の規定の適用については、第366条第1項本文中「各取締役」とあるのは「各特別取締役（…）」と、第368条第1項中「定款」とあるのは「取締役会」と、「各取締役」とあるのは「各特別取締役」と、同条第2項中「取締役（」とあるのは「特別取締役（」と、「取締役及び」とあるのは「特別取締役及び」とする。
    3　特別取締役の互選によって定められた者は、前項の取締役会の決議後、遅滞なく、当該決議の内容を特別取締役以外の取締役に報告しなければならない。
    4　第366条（…）、第367条、第369条第1項、第370条及び第399条の14の規定は、第2項の取締役会については、適用しない。`
